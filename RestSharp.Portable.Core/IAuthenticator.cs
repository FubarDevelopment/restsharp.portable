...
namespace RestSharp.Portable
{
    ...
    public interface IAuthenticator
    {
        ...
        /// <param name="credentials">The credentials to be used for the authentication</param>
        /// <returns>true when the authentication module supports pre-authentication</returns>
        bool CanPreAuthenticate([CanBeNull] IHttpClient client, [NotNull] IHttpRequestMessage request, ICredentials credentials);
        ...
        bool CanHandleChallenge([CanBeNull] IHttpClient client, [NotNull] IHttpRequestMessage request, ICredentials credentials, [NotNull] IHttpResponseMessage response);
        ...
        /// <param name="credentials">The credentials used for the authentication</param>
        /// <returns>The task the authentication is performed on</returns>
        Task PreAuthenticate([CanBeNull] IHttpClient client, [NotNull] IHttpRequestMessage request, ICredentials credentials);
        ...
        Task HandleChallenge([CanBeNull] IHttpClient client, [NotNull] IHttpRequestMessage request, ICredentials credentials, [NotNull] IHttpResponseMessage response);
    }
}
