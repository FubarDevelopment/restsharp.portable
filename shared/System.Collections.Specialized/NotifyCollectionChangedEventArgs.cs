...
namespace System.Collections.Specialized
{
    ...
    /// </summary>
    internal enum NotifyCollectionChangedAction
    {
    ...
    /// </summary>
    internal class NotifyCollectionChangedEventArgs : EventArgs
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action)
        {
            if (action != NotifyCollectionChangedAction.Reset)
                throw new ArgumentException("Action must be Reset", nameof(action));
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action, object changedItem)
        {
            if ((action != NotifyCollectionChangedAction.Add) && (action != NotifyCollectionChangedAction.Remove)
                ...
                throw new ArgumentException("Action must be Add, Remove, or Reset", nameof(action));

            if (action == NotifyCollectionChangedAction.Reset)
            {
                if (changedItem != null)
                    throw new ArgumentException("Changed item must be null", nameof(action));
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action, object changedItem, int index)
        {
            ...
            if (action == NotifyCollectionChangedAction.Reset)
            {
                if (changedItem != null)
                    throw new ArgumentException("Changed item must be null", nameof(action));
                if (index != -1)
                    throw new ArgumentException("Reset requires index == -1", nameof(action));
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action, IList changedItems)
        {
            ...
            if (action == NotifyCollectionChangedAction.Reset)
            {
                if (changedItems != null)
                    throw new ArgumentException("Changed items must be null", nameof(action));
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action, object newItem, object oldItem)
        {
            if (action != NotifyCollectionChangedAction.Replace)
                throw new ArgumentException("Action must be Replace", nameof(action));
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action, object changedItem, int index, int oldIndex)
        {
            if (action != NotifyCollectionChangedAction.Move)
                throw new ArgumentException("Action must be Move", nameof(action));
            if (index < 0)
    ...
    /// </summary>
    internal delegate void NotifyCollectionChangedEventHandler(object sender, NotifyCollectionChangedEventArgs e);
