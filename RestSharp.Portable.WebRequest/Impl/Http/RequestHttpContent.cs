...
{
    /// <summary>
    /// A shallow wrapper around a <see cref="WebRequest"/> instance.
    /// </summary>
    public class RequestHttpContent : IHttpContent
    {
        ...
        public RequestHttpContent([NotNull] System.Net.WebRequest content)
        {
            Content = content;
        ...
        /// </summary>
        public System.Net.WebRequest Content { get; private set; }
